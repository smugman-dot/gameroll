...
export const urlToStoreType = (url = "") => {
    ...
    if (u.includes("store.steampowered.com") || u.includes("steam")) return "steam";
    if (u.includes("epicgames")) return "epicgames";
    if (u.includes("gog.com") || u.includes("gog")) return "gog";
    if (u.includes("playstation.com") || u.includes("psn") || u.includes("playstation")) return "playstation";
    if (u.includes("xbox.com") || u.includes("microsoft.com") || u.includes("xbox")) return "xbox";
    if (u.includes("nintendo") || u.includes("eshop")) return "nintendo";
    return "website";
};

export const choosePrimaryStoreLink = (storeLinks = [], preferMobile = false) => {
    ...
    const priority = ["steam", "epicgames", "gog", "playstation", "xbox", "nintendo", "website"];
