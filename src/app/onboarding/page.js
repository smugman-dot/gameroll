                ...
                >
                  {genres.map((genre) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`relative z-10 font-medium text-lg md:text-xl tracking-wide transition-colors duration-300 ${isSelected ? "font-bold" : ""}`}
                        >
                          {genre.name}
                        </span>
                        ...
                        {/* Status Dot */}
                        <div
                          className={`mt-2 w-1.5 h-1.5 rounded-full transition-all duration-300 ${isSelected ? "bg-black" : "bg-white/10 group-hover:bg-white/50"}`}
                        />
                      </motion.button>
                    );
                  })}
              ...
              <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
                ...
                >
                  ...
                  <span className="text-2xl font-medium">
                    {selectedCount} <span className="text-white/30">/ 3</span>
                  </span>
                </motion.div>
